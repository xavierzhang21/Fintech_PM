...
(function () {
  ...
  setTimeout(function () {
    ...
    document.querySelectorAll('.reveal-slide').forEach(function (el) { el.classList.add('visible'); });
  }, 600);
  ...
  if ('IntersectionObserver' in window) {
    ...
    /* ── Text slide-up observer for .reveal-slide headings ── */
